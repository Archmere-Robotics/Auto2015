...
task main() {
	...
	Stop();
	nxtDisplayCenteredTextLine(0,"A: B: C: D: ");
	nxtDisplayCenteredTextLine(1,"%d%d%d%d",nMotorEncoder[wheelA],nMotorEncoder[wheelB],nMotorEncoder[wheelC],nMotorEncoder[wheelD]);
	nxtDisplayCenteredTextLine(2,"Lift:");
	nxtDisplayCenteredTextLine(3,"%d",nMotorEncoder[liftMotor];
}
#endif
